...
var _sliderHero = require("./modules/hero/sliderHero");
var _initAccordion = require("./vendor/init-accordion");
var _sliderPrograms = require("./modules/programs/sliderPrograms");
var _sliderResize = require("./modules/programs/sliderResize");
var _sliderNews = require("./modules/news/sliderNews");
var _sliderReviews = require("./modules/rewiews/sliderReviews");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _sliderHero.initHeroSlider)();
    (0, _sliderPrograms.initProgramsSlider)();
    (0, _sliderResize.sliderWindowResize)();
    (0, _sliderNews.initNewsSlider)();
    (0, _sliderReviews.initReviewsSlider)();
...
var initHeroSlider = function initHeroSlider() {
  ...
  var heroSlider = new _swiper.default(heroContainer, {
...
},{"../../utils/is-mobile":25,"../../vendor/swiper":31}],10:[function(require,module,exports){
"use strict";
...
var initContactsMap = function initContactsMap() {
  if (document.querySelector('#map')) {
    ...
    var coordinate = [55.028820, 82.928150];
    var url = 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var markerText = "\n<p style=\"width: 230px\" >\u0433. \u041D\u043E\u0432\u043E\u0441\u0438\u0431\u0438\u0440\u0441\u043A, \u0443\u043B. \u0429\u0435\u0442\u0438\u043D\u043A\u0438\u043D\u0430 68, \u043A\u0443\u043B\u044C\u0442\u0443\u0440\u043D\u044B\u0439 \u0446\u0435\u043D\u0442\u0440 \xAB\u0411\u0435\u0439\u0442 \u041C\u0435\u043D\u0430\u0445\u0435\u043C\xBB</p>\n<p>\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430: <a href=\"tel:896387687676\">8 963 876 876 76</a></p>\n";
...
},{"../../vendor/leaflet":30}],11:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":26}],12:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":26}],14:[function(require,module,exports){
"use strict";
...
var newsData = [{
  ...
  text: "\u0421\u0430\u0448\u0430 \u0440\u0430\u0441\u0441\u043A\u0430\u0437\u044B\u0432\u0430\u0435\u0442, \u043A\u0430\u043A \u043F\u043E\u043F\u0430\u043B\u0430 \u0432\xA0\u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0443 \u0438\xA0\u043A\u0430\u043A\xA0\u043F\u0440\u043E\u0448\u043B\u0430 6- \u043C\u0435\u0441\u044F\u0447\u043D\u0430\u044F \u0441\u0442\u0430\u0436\u0438\u0440\u043E\u0432\u043A\u0430 \u0432\xA0ISOFound"
}, {
  type: 'trips',
  src: 'img/news/news-trips.jpg',
  srcset: 'img/news/news-trips@2x.jpg 2x',
  date: '20/03/2023',
  title: "\u041F\u0443\u0442\u0435\u0448\u0435\u0441\u0442\u0432\u0443\u0435\u043C \u043F\u043E\xA0\u0418\u0437\u0440\u0430\u0438\u043B\u044E",
  ...
  text: "\u041F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430 \u043F\u043E\u043C\u043E\u0449\u0438 \u0434\u0435\u0442\u044F\u043C \u0434\u043B\u0438\u0442\u0435\u043B\u044C\u043D\u043E\u0441\u0442\u044C\u044E 4\xA0\u043C\u0435\u0441\u044F\u0446\u0430"
}, {
  type: 'career',
...
exports.renderNews = exports.initNewsSlider = void 0;
var _newsData = require("./news-data.js");
var _swiper = _interopRequireDefault(require("../../vendor/swiper.js"));
var _isMobile = require("../../utils/is-mobile");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var newsCardNode = document.querySelector('#news-card').content.querySelector('.news-card');
var sliderNews = document.querySelector('.news__slider');
var newsTabsNode = document.querySelectorAll('.news__btn');
var initNewsSlider = function initNewsSlider() {
  renderNews(_newsData.newsData);
  ...
  newsTabsNode.forEach(function (btn) {
    return btn.addEventListener('click', function () {
      newsTabsNode.forEach(function (el) {
      ...
      if (filter === 'all') {
        ...
        var newNews = _newsData.newsData.filter(function (el) {
...
var renderNews = function renderNews(arr) {
  var newsSliderContainer = document.querySelector('.news__wrapper');
  var breakpointChecker = function breakpointChecker() {
    switch (true) {
      case window.matchMedia('(min-width: 1200px)').matches:
        {
          ...
          slice.forEach(function (elem, index) {
            var newCard = createNew(elem);
            if (index % 3 === 0) {
      ...
      case window.matchMedia('(min-width: 768px)').matches:
        {
          newsSliderContainer.innerHTML = '';
          var newsDataChunked = chunkArray(arr, 4);
          newsDataChunked.forEach(function (item) {
            var element = document.createElement('div');
            element.classList.add('slide-new');
            element.classList.add('swiper-slide');
            for (var i = 0; i < item.length; i++) {
              var newCard = createNew(item[i]);
      ...
      case window.matchMedia('(min-width: 320px)').matches:
        {
          newsSliderContainer.innerHTML = '';
          var newsDataChunkedMobile = chunkArray(arr, 2);
          newsDataChunkedMobile.forEach(function (item) {
            var element = document.createElement('div');
            element.classList.add('slide-new');
            element.classList.add('swiper-slide');
            for (var i = 0; i < item.length; i++) {
...
var createNew = function createNew(elem) {
  var newCard = newsCardNode.cloneNode(true);
...
},{"../../utils/is-mobile":25,"../../vendor/swiper.js":31,"./news-data.js":14}],16:[function(require,module,exports){
"use strict";
...
var initProgramsSlider = function initProgramsSlider() {
  var programsContainer = document.querySelector('.programs__slider');
  var programsControl = document.querySelector('.programs__arrows');
  programsControl.removeAttribute('data-nojs');
  var programsSlider = new _swiper.default(programsContainer, {
    // cssMode: true,
    allowTouchMove: (0, _isMobile.isMobile)(),
    slidesPerView: 'auto',
    observer: true,
...
},{"../../utils/is-mobile":25,"../../vendor/swiper":31}],17:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sliderWindowResize = sliderWindowResize;
var programsHeading = document.querySelector('.programs__heading');
var programsButton = document.querySelector('.programs__button');
var programsContainer = document.querySelector('.programs__container');
var programsControl = document.querySelector('.programs__control');
var reviewsTitle = document.querySelector('.reviews__title');
var reviewsContainer = document.querySelector('.reviews__container');
var reviewsControl = document.querySelector('.reviews__control');
...
var initReviewsSlider = function initReviewsSlider() {
  ...
  var reviewsControl = document.querySelector('.reviews__arrows');
  reviewsControl.removeAttribute('data-nojs');
  var reviewsSlider = new _swiper.default(reviewsContainer, {
    allowTouchMove: (0, _isMobile.isMobile)(),
    slidesPerView: 'auto',
    observer: true,
    observeParents: true,
...
},{"../../utils/is-mobile.js":25,"../../vendor/swiper.js":31}],19:[function(require,module,exports){
"use strict";
...
var Accordions = /*#__PURE__*/function () {
  ...
  _createClass(Accordions, [{
    ...
    value: function _documentClickHandler(evt) {
      ...
      var element = target.closest('[data-accordion="button"]' && '[data-accordion="element"]');
...
},{"./accordions":27}],30:[function(require,module,exports){
"use strict";
